...
The page contains the step to reproduce the results:
...
Revision:
- Base on the suggestion of Reviewer, we add the "VarExp_by_iPVs.R", to calculate the variance explained by metabolites (selected using IPVs method) for the whole metabolomic data
